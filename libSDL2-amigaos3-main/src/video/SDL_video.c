...
{
#if defined(__AMIGAOS3__) && defined(SDL_VIDEO_OPENGL)
    /*
     * minigl.library exposes an OpenGL 1.x style API and does not provide
     * the desktop OpenGL 3 framebuffer attachment enums used by SDL2's
     * generic attribute-query path.  The AmigaOS3 backend negotiates the
     * context from gl_config, so report those negotiated/requested values
     * directly instead of pulling in GL3/FBO-only queries.
     */
    if (!value) {
    ...
    switch (attr) {
    case SDL_GL_RED_SIZE:                    *value = _this->gl_config.red_size; return 0;
    case SDL_GL_GREEN_SIZE:                  *value = _this->gl_config.green_size; return 0;
    case SDL_GL_BLUE_SIZE:                   *value = _this->gl_config.blue_size; return 0;
    case SDL_GL_ALPHA_SIZE:                  *value = _this->gl_config.alpha_size; return 0;
    case SDL_GL_DOUBLEBUFFER:                *value = _this->gl_config.double_buffer; return 0;
    case SDL_GL_BUFFER_SIZE:                 *value = _this->gl_config.buffer_size; return 0;
    case SDL_GL_DEPTH_SIZE:                  *value = _this->gl_config.depth_size; return 0;
    case SDL_GL_STENCIL_SIZE:                *value = _this->gl_config.stencil_size; return 0;
    case SDL_GL_ACCUM_RED_SIZE:              *value = _this->gl_config.accum_red_size; return 0;
    case SDL_GL_ACCUM_GREEN_SIZE:            *value = _this->gl_config.accum_green_size; return 0;
    case SDL_GL_ACCUM_BLUE_SIZE:             *value = _this->gl_config.accum_blue_size; return 0;
    case SDL_GL_ACCUM_ALPHA_SIZE:            *value = _this->gl_config.accum_alpha_size; return 0;
    case SDL_GL_STEREO:                      *value = _this->gl_config.stereo; return 0;
    case SDL_GL_MULTISAMPLEBUFFERS:          *value = _this->gl_config.multisamplebuffers; return 0;
    case SDL_GL_MULTISAMPLESAMPLES:          *value = _this->gl_config.multisamplesamples; return 0;
    case SDL_GL_ACCELERATED_VISUAL:          *value = (_this->gl_config.accelerated != 0); return 0;
    case SDL_GL_RETAINED_BACKING:            *value = _this->gl_config.retained_backing; return 0;
    case SDL_GL_CONTEXT_MAJOR_VERSION:       *value = _this->gl_config.major_version; return 0;
    case SDL_GL_CONTEXT_MINOR_VERSION:       *value = _this->gl_config.minor_version; return 0;
    case SDL_GL_CONTEXT_FLAGS:               *value = _this->gl_config.flags; return 0;
    case SDL_GL_CONTEXT_PROFILE_MASK:        *value = _this->gl_config.profile_mask; return 0;
    case SDL_GL_SHARE_WITH_CURRENT_CONTEXT:  *value = _this->gl_config.share_with_current_context; return 0;
    case SDL_GL_FRAMEBUFFER_SRGB_CAPABLE:    *value = _this->gl_config.framebuffer_srgb_capable; return 0;
    case SDL_GL_CONTEXT_NO_ERROR:            *value = _this->gl_config.no_error; return 0;
    case SDL_GL_FLOATBUFFERS:                *value = _this->gl_config.floatbuffers; return 0;
    case SDL_GL_CONTEXT_EGL:                 *value = 0; return 0;
    case SDL_GL_CONTEXT_RELEASE_BEHAVIOR:    *value = 0; return 0;
    default:
    ...
    *value = 0;
    ...
    return SDL_Unsupported();
#endif /* SDL_VIDEO_OPENGL */
#endif /* __AMIGAOS3__ && SDL_VIDEO_OPENGL */
}
